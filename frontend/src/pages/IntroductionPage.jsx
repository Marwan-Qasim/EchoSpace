...
const IntroductionPage = () => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <header className="relative z-10 mx-auto flex w-full max-w-6xl items-center justify-between px-10 pt-5 text-sm text-gray-200">
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        <div className="w-full max-w-4xl">
          ...
          <p className="mx-auto mt-7 max-w-3xl text-sm font-light text-gray-300 md:text-xl">
            EchoSpace is built for spontaneous conversations, new connections, and moments shared instantly across the
            world.
          </p>
          <Link
            to="/chat"
            className="mt-10 inline-flex items-center justify-center rounded-full border border-white/20 bg-zinc-700/40 px-12 py-4 text-xl font-medium text-white backdrop-blur-sm transition-all hover:bg-zinc-500/50"
          >
            Continue
          </Link>
        </div>
        ...
        <footer className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center text-xs text-gray-400">
          ...
          <a href="https://github.com/" target="_blank" rel="noreferrer" className="inline-flex hover:text-white">
